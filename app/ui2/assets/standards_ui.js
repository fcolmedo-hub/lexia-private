...
(function(){
  ...
  function shell(){
    ...
    node.querySelector('#stdReservedControl').addEventListener('click',event=>{event.preventDefault();event.stopPropagation();reservedQueue({page:1});});
  ...
  async function loadInventory(){
    ...
    try{
      ...
      const reservedControl=document.getElementById('stdReservedControl');
      if(reservedControl)reservedControl.textContent=`Revisar ${reserved} ${reserved===1?'reservada':'reservadas'}`;
