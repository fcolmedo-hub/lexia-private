...
(function(){
  ...
  function installStyles(){
    ...
    style.textContent=`
      ...
      html.lexia-standards-open,html.lexia-standards-open body{overflow:hidden!important}
      #lexiaStandardsShell{position:fixed;z-index:850;top:0;right:0;bottom:0;left:224px;background:#fbfcff;overflow-x:hidden;overflow-y:auto;overscroll-behavior:contain;scrollbar-gutter:stable;display:none;color:var(--std-ink)}#lexiaStandardsShell.open{display:block}#lexiaStandardsShell *{box-sizing:border-box}
