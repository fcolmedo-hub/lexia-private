...
(function () {
  ...
  function openEvidenceDialog(snapshot, node, block, documents, existing) {
    ...
    dialog.append(el('header', {className: 'evidence-dialog-head'}, close, el('b', {textContent: 'Seleccionar evidencia para el bloque'})), el('div', {className: 'evidence-dialog-body'}, field('Documento del caso', select), reader, status, el('div', {className: 'evidence-dialog-actions'}, save)));
