...
(function () {
  ...
  let showNewCase = false, editingCase = false;
  ...
  function openCreationDialog(title, buildForm) {
    const dialog = el('dialog', {className: 'lexia-evidence-dialog cases-create-dialog'});
