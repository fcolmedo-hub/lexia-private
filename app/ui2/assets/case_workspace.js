...
(function () {
  ...
  function openEvidenceDialog(snapshot, node, block, documents, existing) {
    ...
    const load = async () => {
      selectedRanges = []; existingRange = null; changingSelection = !existing; clearEvidenceHighlights(); reader.classList.toggle('evidence-reader-editing', !existing); status.textContent = 'Cargando el texto indexado de LexIA…'; reader.textContent = '';
      try {
