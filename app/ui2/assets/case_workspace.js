...
(function () {
  ...
  function style() {
    ...
    const css = [
      '#searchpage #realSearchResults .result-card:not(:has(.result-actions>.score)){box-sizing:border-box!important;min-height:76px!important;height:auto!important;max-height:none!important;padding:10px 14px!important;align-items:center!important;overflow:visible!important}#searchpage #realSearchResults .result-card:not(:has(.result-actions>.score)) .result-body{box-sizing:border-box!important;display:flex!important;flex-direction:column!important;align-items:flex-start!important;justify-content:center!important;gap:2px!important;min-width:0!important;min-height:54px!important;height:auto!important;overflow:hidden!important}#searchpage #realSearchResults .result-card:not(:has(.result-actions>.score)) .result-title{display:block!important;width:100%!important;min-width:0!important;min-height:0!important;height:auto!important;margin:0!important;padding:0!important;line-height:1.3!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}#searchpage #realSearchResults .result-card:not(:has(.result-actions>.score)) .result-meta{display:block!important;box-sizing:border-box!important;width:100%!important;min-width:0!important;margin:0!important;line-height:1.25!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}#searchpage #realSearchResults .result-card:not(:has(.result-actions>.score)) .result-path{display:block!important;box-sizing:border-box!important;width:100%!important;min-width:0!important;margin:1px 0 0!important;line-height:1.2!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}',
      ...
      '#searchpage #realSearchResults .result-card.result-menu-open{position:relative!important;z-index:10110!important}',
  ...
  function closeResultActionMenu() {
    ...
    activeResultActionMenu.menu.closest('.result-card')?.classList.remove('result-menu-open');
  ...
  function installResultActionMenu(card, actions) {
    ...
    if (!menu) {
      ...
      toggle.addEventListener('click', event => {
        ...
        menu.closest('.result-card')?.classList.add('result-menu-open');
