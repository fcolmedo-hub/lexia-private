...
(function () {
  ...
  function style() {
    ...
    const css = [
      ...
      '#searchpage #realSearchResults .result-card{grid-template-columns:24px minmax(0,1fr) 102px!important;column-gap:8px!important;padding:8px 10px!important;margin-bottom:6px!important;min-height:0!important;align-items:center!important}#searchpage #realSearchResults .result-rank{width:24px!important;height:24px!important;border-radius:7px!important;font-size:10px!important}#searchpage #realSearchResults .result-title,#searchpage #realSearchResults .result-title-btn{font-size:11px!important;line-height:1.25!important}#searchpage #realSearchResults .result-meta,#searchpage #realSearchResults .result-path{font-size:9px!important;line-height:1.25!important}#searchpage #realSearchResults .result-actions{grid-template-columns:repeat(5,18px)!important;grid-template-rows:18px 16px!important;width:102px!important;min-width:102px!important;max-width:102px!important;gap:3px!important}#searchpage #realSearchResults .result-actions .search-open-file,#searchpage #realSearchResults .result-actions .search-investigate-file,#searchpage #realSearchResults .result-actions .search-file-info,#searchpage #realSearchResults .result-actions .search-delete-file,#searchpage #realSearchResults .result-actions [data-lexia-case-link],#searchpage #realSearchResults .result-actions [data-lexia-ocr-reprocess]{width:18px!important;min-width:18px!important;height:18px!important;min-height:18px!important;border-radius:5px!important}#searchpage #realSearchResults .result-actions .search-open-file::before,#searchpage #realSearchResults .result-actions .search-investigate-file::before,#searchpage #realSearchResults .result-actions [data-lexia-case-link]::before,#searchpage #realSearchResults .result-actions [data-lexia-ocr-reprocess]::before{font-size:11px!important}#searchpage #realSearchResults .result-actions .search-file-info::before{font-size:10px!important}#searchpage #realSearchResults .result-actions .search-delete-file::before{font-size:12px!important}#searchpage #realSearchResults .result-actions .score{grid-column:5!important;grid-row:2!important;width:18px!important;min-width:18px!important;height:16px!important;min-height:16px!important;padding:0!important;font-size:7px!important}#searchpage #realSearchResults .result-actions .lexia-ocr-status{grid-column:1 / 5!important;grid-row:2!important;font-size:7px!important}',
