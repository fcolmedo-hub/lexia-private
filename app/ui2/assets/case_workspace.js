...
(function () {
  'use strict';
  if (/Windows/i.test(String(navigator.userAgent || navigator.platform || ''))) {
    document.documentElement.classList.add('lexia-platform-windows');
  }
  ...
  function style() {
    ...
    const css = [
      ...
      'html.lexia-platform-windows #searchpage #realSearchResults .result-card{grid-template-columns:24px minmax(0,1fr) 110px!important;column-gap:8px!important;padding:10px!important;margin-bottom:7px!important;min-height:50px!important;height:auto!important;max-height:none!important;align-items:start!important;overflow:hidden!important;box-sizing:border-box!important}html.lexia-platform-windows #searchpage #realSearchResults .result-rank{width:24px!important;height:24px!important;border-radius:7px!important;font-size:10px!important}html.lexia-platform-windows #searchpage #realSearchResults .result-body{display:block!important;min-width:0!important;min-height:30px!important;height:auto!important;max-height:none!important;overflow:visible!important}html.lexia-platform-windows #searchpage #realSearchResults .result-title,html.lexia-platform-windows #searchpage #realSearchResults .result-title-btn{display:block!important;visibility:visible!important;font-size:11px!important;line-height:1.3!important}html.lexia-platform-windows #searchpage #realSearchResults .result-meta,html.lexia-platform-windows #searchpage #realSearchResults .result-path{font-size:9px!important;line-height:1.3!important}html.lexia-platform-windows #searchpage #realSearchResults .result-actions{grid-template-columns:repeat(5,20px)!important;grid-template-rows:20px 18px!important;width:110px!important;min-width:110px!important;max-width:110px!important;min-height:41px!important;height:auto!important;align-self:start!important;align-content:start!important;overflow:visible!important;gap:3px!important}html.lexia-platform-windows #searchpage #realSearchResults .result-actions .search-open-file,html.lexia-platform-windows #searchpage #realSearchResults .result-actions .search-investigate-file,html.lexia-platform-windows #searchpage #realSearchResults .result-actions .search-file-info,html.lexia-platform-windows #searchpage #realSearchResults .result-actions .search-delete-file,html.lexia-platform-windows #searchpage #realSearchResults .result-actions [data-lexia-case-link],html.lexia-platform-windows #searchpage #realSearchResults .result-actions [data-lexia-ocr-reprocess]{width:20px!important;min-width:20px!important;height:20px!important;min-height:20px!important;border-radius:6px!important}html.lexia-platform-windows #searchpage #realSearchResults .result-actions .search-open-file::before,html.lexia-platform-windows #searchpage #realSearchResults .result-actions .search-investigate-file::before,html.lexia-platform-windows #searchpage #realSearchResults .result-actions [data-lexia-case-link]::before,html.lexia-platform-windows #searchpage #realSearchResults .result-actions [data-lexia-ocr-reprocess]::before{font-size:12px!important}html.lexia-platform-windows #searchpage #realSearchResults .result-actions .search-file-info::before{font-size:10px!important}html.lexia-platform-windows #searchpage #realSearchResults .result-actions .search-delete-file::before{font-size:13px!important}html.lexia-platform-windows #searchpage #realSearchResults .result-actions .score{grid-column:5!important;grid-row:2!important;width:20px!important;min-width:20px!important;height:18px!important;min-height:18px!important;padding:0!important;font-size:7px!important}html.lexia-platform-windows #searchpage #realSearchResults .result-actions .lexia-ocr-status{grid-column:1 / 5!important;grid-row:2!important;font-size:7px!important}',
