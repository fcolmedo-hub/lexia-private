...
(function () {
  ...
  function style() {
    ...
    const css = [
      ...
      '#' + PAGE_ID + ' .evidence-reader{cursor:text!important;-webkit-user-select:text!important;user-select:text!important}#' + PAGE_ID + ' .evidence-reader::selection{background:#f1d64f!important;color:#202944!important}#' + PAGE_ID + ' .evidence-existing-mark{background:#fff19c!important;color:#202944!important;padding:1px 0;border-radius:2px;box-shadow:0 0 0 1px #e1c542;-webkit-user-select:text;user-select:text}#' + PAGE_ID + ' .evidence-new-mark{background:#f1d64f!important;color:#202944!important;padding:1px 0;border-radius:2px;box-shadow:0 0 0 1px #d0ad16;-webkit-user-select:text;user-select:text}',
  ...
  function openEvidenceDialog(snapshot, node, block, documents, existing) {
    ...
    actions.append(save);
    dialog.append(el('header', {className: 'evidence-dialog-head'}, el('b', {textContent: 'Seleccionar evidencia para el bloque'}), close), el('div', {className: 'evidence-dialog-body'}, field('Documento del caso', select), reader, status, actions));
