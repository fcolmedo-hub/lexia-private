...
def ensure_ui_assets(root: Path) -> str | None:
    ...
    if standards_ui.exists() and "assets/standards_ui.js" not in patched:
        ...
        body_tags.append('<script src="assets/standards_ui.js?v=standards-ui-2"></script>')

    if standards_nav_fix.exists() and "assets/standards_nav_fix.js" not in patched:
        body_tags.append('<script src="assets/standards_nav_fix.js?v=standards-nav-fix-2"></script>')
