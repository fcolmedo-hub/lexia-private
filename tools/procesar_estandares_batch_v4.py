...
DEFAULT_PROMPTS = REPO_ROOT / "runtime" / "standards_pilot" / "export_50_v4" / "prompts.jsonl"
DEFAULT_WORKDIR = REPO_ROOT / "runtime" / "standards_pilot" / "batch_luna_v4"
                ...
                "properties": {
                    ...
                    "evidence": {
                        ...
                        "items": {
                            ...
                            "required": ["chunk_id", "start_anchor", "end_anchor"],
...
def cmd_submit(args: argparse.Namespace) -> int:
    ...
    batch = client.batches.create(
        ...
        metadata={"purpose": "lexia-standards-v4"},
    )
    state = {
        "batch_id": batch.id,
        "input_file_id": uploaded.id,
    ...
    for raw in raw_text.splitlines():
        ...
        try:
            ...
            if valid:
                ...
                validation_error = "La respuesta v4 no tiene standards=array"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Batch v4: Structured Outputs + evidencia por anclas.")
